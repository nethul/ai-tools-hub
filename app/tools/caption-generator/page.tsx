...
import CaptionGeneratorInterface from '@/components/caption-generator/CaptionGeneratorInterface';
        ...
        <main className="min-h-screen bg-slate-950 text-slate-200">
            ...
            <div className="px-4 text-center">
                ...
                <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-8">
                    Create engaging, viral-ready captions for any platform in seconds.
                    Perfect hashtags included.
                </p>
            </div>
